public class ArraysExercises {
   ...
   //                                                                                  - param -> array
    ...
    // pass that array to find average() method
    ...
    // create the average method here
    // then call it in the main method
    public static int findAverage(int numbers[]){
        // create 2 variables - sum and average
        //[1, 2, 3, 4, 5]
        int sum = 0;
        int average;

        // create a loop to extract a single element and add it to sum
    ...
    // create a method that takes an arrays of integers as a parameter
    // then checks for the smallest integer in that array and returns it
